...
token_id :: enum {
  ...
  delete_char = 127,
  // ------------------------------------
  // maybe_euro_sign_unassigned_128 = 128,
  // maybe_high_sierra_a = 129,
  // maybe_high_sierra_e,
  // maybe_high_sierra_i,
  // maybe_high_sierra_o,
  // maybe_high_sierra_u,
  ...
  maybe_right_angle_quote_double = 'µ',
  maybe_three_quarters_fraction = '¶',
  maybe_ae_ligature = '·',
  maybe_soft_hyphen = '¸',
  maybe_a_with_grave = '¹',
  maybe_a_with_acute = 'º',
  maybe_a_with_circumflex = '»',
  maybe_a_with_tilde = '¼',
  maybe_a_with_diaeresis = '½',
  maybe_a_with_ring = '¾',
  maybe_ae_capital_ligature = '¿',
  maybe_c_with_cedilla = 'À',
  maybe_e_with_grave = 'Á',
  maybe_e_with_acute = 'Â',
  maybe_e_with_circumflex = 'Ã',
  maybe_e_with_diaeresis = 'Ä',
  maybe_i_with_grave = 'Å',
  maybe_i_with_acute = 'Æ',
  maybe_i_with_circumflex = 'Ç',
  maybe_i_with_diaeresis = 'È',
  maybe_eth_capital = 'É',
  maybe_n_with_tilde = 'Ê',
  maybe_o_with_grave = 'Ë',
  maybe_o_with_acute = 'Ì',
  maybe_o_with_circumflex = 'Í',
  maybe_o_with_tilde = 'Î',
  maybe_o_with_diaeresis = 'Ï',
  maybe_multiply_sign = 'Ð',
  maybe_o_slash = 'Ñ',
  maybe_u_with_grave = 'Ò',
  maybe_u_with_acute = 'Ó',
  maybe_u_with_circumflex = 'Ô',
  maybe_u_with_diaeresis = 'Õ',
  maybe_y_with_acute = 'Ö',
  maybe_thorn_capital = '×',
  maybe_sharp_s = 'Ø',
  maybe_eth_small = 'Ù',
  maybe_n_with_tilde_capital = 'Ú',
  maybe_o_with_grave_capital = 'Û',
  maybe_o_with_acute_capital = 'Ü',
  maybe_o_with_circumflex_capital = 'Ý',
  maybe_o_with_tilde_capital = 'Þ',
  maybe_o_with_diaeresis_capital = 'ß',
  maybe_division_sign = 'à',
  maybe_o_slash_capital = 'á',
  maybe_u_with_grave_capital = 'â',
  maybe_u_with_acute_capital = 'ã',
  maybe_u_with_circumflex_capital = 'ä',
  maybe_u_with_diaeresis_capital = 'å',
  maybe_y_with_acute_capital = 'æ',
  maybe_thorn_small = 'ç',
  maybe_y_with_diaeresis = 'è',
  // ------------------------------------
